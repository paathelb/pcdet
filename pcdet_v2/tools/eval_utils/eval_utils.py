...
def eval_one_epoch(cfg, model, dataloader, epoch_id, logger, dist_test=False, save_to_file=False, result_dir=None):
    ...
    # MODIFIED by Helbert PAAT <-- Uncomment this to bring original code
    if cfg.LOCAL_RANK == 0:
...
#########################################################################################################################################################################################################################
    ...
    # with open('/home/hpaat/my_exp/MTrans_copy/output/kitti_fgr/mtrans_fgr_acc_obj_3d_iou_5000/det_annos_269.pkl', 'rb') as f: 
