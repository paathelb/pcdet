...
class RoIHeadTemplate(nn.Module):
    ...
    def get_box_reg_layer_loss(self, forward_ret_dict):
        ...
        loss_weights_ = forward_ret_dict['loss_weights'].squeeze(-1)
        loss_weights = batch_gt_assignment.new_zeros((loss_weights_.shape[0], loss_weights_.shape[1]), dtype=torch.float) + 1.0 
